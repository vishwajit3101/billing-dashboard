...
def test_final_endpoints():
    ...
    endpoints = [
        f"https://api.anthropic.com/v1/organizations/{ANTHROPIC_ORG_ID}/billing/balance",
        f"https://api.anthropic.com/v1/organizations/{ANTHROPIC_ORG_ID}/credits",
        f"https://api.anthropic.com/v1/organizations/{ANTHROPIC_ORG_ID}/stats",
