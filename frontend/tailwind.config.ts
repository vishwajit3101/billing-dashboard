    ...
    extend: {
      colors: {
        ...
        anthropic: {
          ...
          muted: "hsl(var(--anthropic-muted))",
        },
        aws: {
          DEFAULT: "hsl(var(--aws))",
          foreground: "hsl(var(--aws-foreground))",
          muted: "hsl(var(--aws-muted))",
        },
        tavily: {
          DEFAULT: "hsl(var(--tavily))",
          muted: "hsl(var(--tavily-muted))",
        },
        fullenrich: {
          DEFAULT: "hsl(var(--fullenrich))",
          muted: "hsl(var(--fullenrich-muted))",
        },
        buyercaddy: {
